...
- **Search Page:** Multi-dropdown selection for source/destination hubs
...
- **Booking Creation:** Stores booking with status "booked" in Realtime DB
...
2. Verify reference path: `DatabaseReference("bookings").push()`
